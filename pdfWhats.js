document.addEventListener('DOMContentLoaded', function() {
    function generatePdf() {
        ...
        const municipioInput = document.querySelector('#containerWhats .municipio');
        ...
        const monthlyCost = document.querySelector('#containerWhats .monthly-cost').textContent || '0';
        const annualCost = document.querySelector('#containerWhats .annual-cost').textContent || '0';
        const implementationCost = document.querySelector('#containerWhats .implementation-cost').textContent || '0';
        const technicalHoursCost = document.querySelector('#containerWhats .valor-horas-tecnicas').value || '0';
        const technicalHoursQuantity = document.querySelector('#containerWhats .horas-tecnicas').value || '0';
        ...
        <img src="data:image/png;base64," alt="Logo" style="width: 100%; max-height: 150px; object-fit: contain; margin-bottom: 20px;">
                ...
                <h2 class="center-align large-margin-bottom" style="margin-top: 40px;">ORÇAMENTO SISTEMA DE GESTÃO WHATS</h2>
                <p class="text-margin">A empresa TECNOLÓGICA PRESTADORA DE SERVIÇOS DE INFORMÁTICA, inscrita no CNPJ. 09.599.021/0001-40, estabelecida à Avenida Osvaldo Pinto da Veiga, 1323, Próspera, Criciúma/SC, vem por meio deste, apresentar nosso orçamento para o Sistema De Gestão Whats no município de ${municipio}.</p>
            </div>
            ...
            <table class="pdf-table text-margin">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>Integração de Serviços do WhatsApp ao Sistema de Gestão Tributária:
                              -	Consulta de débitos (Emissão de Boletos)
    ...
    const downloadButton = document.querySelector('#containerWhats .generate-pdf');
    if (downloadButton) {
