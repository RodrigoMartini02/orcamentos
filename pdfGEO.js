...
content.innerHTML = `
       <div class="header-text">
        ...
        <p class="text-margin">A empresa TECNOLÓGICA PRESTADORA DE SERVIÇOS DE INFORMÁTICA, inscrita no CNPJ. 09.599.021/0001-40, estabelecida à Avenida Osvaldo Pinto da Veiga, 1323, Próspera, Criciúma/SC, vem por meio deste, apresentar nosso orçamento para o Sistema De Georreferenciamento no município de ${municipio}.</p>
    </div>
            ...
            <table class="pdf-table text-margin">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>Locação mensal Sistema de Gestão GEO:<br>
                              -	Cartografia;<br>
                              -	Análise Espacial;<br>
                              -	Geoprocessamento;<br>
                              -	Gestão Imobiliária
